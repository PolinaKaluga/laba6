...
//     */
    ...
    public CommandInvoker(UserIO userIO) { //для клиента
        ...
        this.userIO = userIO;
        this.ticketFieldReader = new TicketFieldReader(userIO);
     ...
     */
    public CommandInvoker(UserIO userIO, TicketFieldReader labWorkFieldsReader, ExecuteScriptCommand.Script script) {
        this.clientCommands = new HashMap<>();

        this.userIO = userIO;
        this.ticketFieldReader = labWorkFieldsReader;
        this.script = script;
...
//        clientCommands.put("exit", new ExitCommand());
        ...
        TicketFieldReader ticketFieldReader = new TicketFieldReader(userIO);
        clientCommands.put("add", new AddCommand(collectionManager, ticketFieldReader));


//        clientCommands.put("add", new AddCommand(TicketFieldReader));
//
