...
public class ExecuteScriptCommand extends Command {
     ...
     * @param ticketFieldReader Хранит ссылку на объект, осуществляющий чтение полей из указанного в userIO потока ввода.
     * @param script             Хранит объект класса ExecuteScript.Script, из которого нам следует получить список адресов скриптов.
     */
    public ExecuteScriptCommand(UserIO userIO, TicketFieldReader ticketFieldReader, Script script) {
    ...
    public void execute(String[] arguments, InvocationStatus invocationEnum, PrintStream printStream) throws CannotExecuteCommandException {
        if (invocationEnum.equals(InvocationStatus.CLIENT)) {
            ...
            try {
                ...
                CommandInvoker commandInvoker = new CommandInvoker(userIO, ticketFieldReader, script);
